...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db::asset_trace,
            commands::db::asset_refs_set,
            commands::db::pricing_pull,
            commands::db::pricing_push,
            commands::db::pricing_forget,
            commands::db::pricing_derive,
            ...
            commands::gallery::dir_children_scan,
